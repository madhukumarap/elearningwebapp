...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
	 ...
	 <li><a class="app-menu__item active" href="notification.php"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Notification</span></a></li>
