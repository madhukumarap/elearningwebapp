              ...
              <div class="col-lg-6">
                <form action="treatmentdb.php" method="post">
                  ...
                  <div class="form-group">
					...
					<input class="form-control" type="radio" name="p2" value="NORMAL" >NORMAL<br>
					<input type="radio"class="form-control" name="p2" value="CRITICAL">CRITICAL<br>
					<input type="radio" class="form-control" name="p2" value="OBSERVATION"> NEED TO OBSERVATION <br>
