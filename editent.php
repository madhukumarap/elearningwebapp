  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
	...
	<div class="app-sidebar__user">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item " href="usermesz.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">User Request</span></a></li>        
...
User can search the nearest medical store and diagnosis lab from his location </li>
		 ...
		 <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body">
              <form class="form-horizontal"  action="editdb3.php" method="post">
