...
$query="SELECT * FROM  userprofile"; // selecting data through mysql_query()
				 ...
				 <label class="col-form-label col-form-label-lg" for="inputLarge"> </label><p>Phone :<a href="https://www.truecaller.com/search/in/<?php echo $data['phonenumber']; ?>" target="_blank"><?php echo $data['phonenumber']; ?></a>
                  <tr>
                   ...
                   <td><?php echo $data['bloodgroup']; ?></td>
					<td><form class="row"  action="userdelete.php" method="post"> 
					
					<input  type="text" name="p1" readonly value="<?php echo $data['email']; ?>"  /></td>
					<td>
