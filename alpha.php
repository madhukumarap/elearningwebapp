      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown"><i class="fa fa-user fa-lg"></i></a>
         <ul class="dropdown-menu settings-menu dropdown-menu-right">
			...
			<li><a class="dropdown-item" href="edituser.php"><i class="fa fa-sign-out fa-lg"></i> EDIT PROFILE</a></li> </ul>
        </li>
      </ul>
    </header>
    <!-- Sidebar menu-->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img src="alpha/A.jpg" alt="First Slide">
            </div>
            <div class="item">
                <img src="alpha/B.jpg" alt=" Slide">
            </div>
            <div class="item">
                <img src="alpha/C.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/D.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/E.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/F.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/G.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/H.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/I.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/K.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/L.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/M.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/N.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/O.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/P.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/Q.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/R.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/S.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/T.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/U.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/V.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/W.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/Y.jpg" alt=" Slide">
            </div>
			<div class="item">
                <img src="alpha/Z.jpg" alt=" Slide">
            </div>
