...
<html lang="en">
 ...
 <?php
  ...
  if(mysqli_num_rows(  $query) > 0){
	   $query = "update entrepreneur SET password ='".md5($password)."' where username = '$username'";
 ...
 echo "<div class='form'><h3>!!!!!!!!!!! Please check your username</h3><br/>Click here to try again <a href='efgp.php'>Update password</a></div>";
        ...
        if($result){
            ...
            echo "<div class='form'><h3>password updates successfully</h3><br/>Click here to <a href='entlogin.php'>Login</a></div>";
