  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">ABOUT E-LEARNING</h3>
            <ul>
...
User can search the nearest medical store and diagnosis lab from his location </li>
            ...
            <div class="tile-body">
              <form class="form-horizontal" action="editdb2.php" method="post">
				...
				<div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" name="p4" type="tel"  maxlength="10" minlength="10" placeholder="Enter phone number" required >
                  </div>
                </div>
                <div class="form-group row">
                  <label class="control-label col-md-3">DOCTOR ID</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" name="p5" type="text" VALUE="<?php echo $_SESSION['username']; ?>" readonly >
                  </div>
                </div>
                ...
                <div class="form-group row" >
                  ...
                  <div class="col-md-8" id="locationField">
                    <textarea class="form-control" rows="2" name="p6" type="text" style="text-transform:uppercase" id="autocomplete" required  placeholder="Enter your address"
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAPJaq8h4L3_LgeKhYA9c3ZS6rLuQF75gU&libraries=places&callback=initAutocomplete"
        async defer></script><br><br>
			...
			<div class="col-md-8">
			<select class="form-control" name="p7" required type="text" >
