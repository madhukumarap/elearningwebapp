  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <header class="app-header"><a class="app-header__logo" href="">E-LEARNING</a>
      ...
      <ul class="app-nav">
       ...
       <!--     <li><a class="dropdown-item" href="usereditdash.php"><i class="fa fa-user fa-lg"></i> Profile</a></li>  -->
            <li><a class="dropdown-item" href="adminlogin.php"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <aside class="app-sidebar">
     ...
     <ul class="app-menu">
		 ...
		 <li class="treeview"><a class="app-menu__item" href="emmergencynoti.php" ><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Emmergency notification</span><i class="treeview-indicator fa fa-angle-right"></i></a>
      </ul>
    </aside>
            ...
            <div class="row">
             ...
             <form action="testdb.php" method="post">
                 <div class="form-group">
                   <label for="exampleTextarea">Test ID</label>
                 ...
                 <select class="form-control" name="p2">
                  ...
                  <div class="form-group">
                   <label for="exampleTextarea">UPLOAD FILE</label>
                    <input class="form-control" type="file" name="p3" placeholder="ENTER URL" required>
                  </div>
                     <div class="form-group">
                   <label for="exampleTextarea">OPTION A</label>
                    <input class="form-control" type="text" name="p4" placeholder="test ID" required>
                  </div> 
				   <div class="form-group">
                   <label for="exampleTextarea">OPTION B</label>
                    <input class="form-control" type="text" name="p5" placeholder="test ID" required>
                  </div> 
				  <div class="form-group">
                   <label for="exampleTextarea">OPTION C</label>
                    <input class="form-control" type="text" name="p6" placeholder="test ID" required>
                  </div> 
				   <div class="form-group">
                   <label for="exampleTextarea">OPTION D</label>
                    <input class="form-control" type="text" name="p7" placeholder="test ID" required>
                  </div> 
				    <div class="form-group">
                   <label for="exampleTextarea">CORRECT ANSWER</label>
                    <input class="form-control" type="text" name="p8" placeholder="test ID" required>
                  </div> 
				  
                  <div class="form-group">
                   <label for="exampleTextarea">ABOUT TEST</label>
                    <textarea class="form-control"  name="p9" id="exampleTextarea" rows="3" required></textarea>
                  </div>
