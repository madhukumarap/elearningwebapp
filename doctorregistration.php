...
<html lang="en">
 ...
 error_reporting(0);
  ...
  if(mysqli_num_rows(  $query) > 0){
    echo "<div class='form'><h3>!!!!!!!!!!! user name already exist please user other.</h3><br/>Click here to try again <a href='doctorregistration.php'>Register</a></div>";
        ...
        if($result){
            echo "<div class='form'><h3>You are registered successfully.</h3><br/>Click here to <a href='doctorlogin.php'>Login</a></div>";
        }
    }else{
?>
    <!-- Navbar-->
   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i>DOCTOR REGISTER</h1>
          ...
          <div class="tile">
            ...
            <div class="tile-body">
             <h3 class="title">Welcome Doctor</h3><br>
			  ...
			  <br>
			  <br><br>
			  <b> "The good physician treats the decease. the great physician treats the  patients who has the disease."<b><br><br> <br><br>
            </div>
			</div>
</div>
        </div></div>
