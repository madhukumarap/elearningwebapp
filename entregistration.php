...
<html lang="en">
 ...
 $query = mysqli_query($con, "SELECT * FROM entrepreneur WHERE username = '".$username. "'");
  ...
  if(mysqli_num_rows(  $query) > 0){
   echo "<div class='form'><h3>!!!!!!!!!!! user name already exist please user other.</h3><br/>Click here to try again <a href='entregistration.php'>Register</a></div>";
        ...
        $query = "INSERT into `entrepreneur` (username, password, email, trn_date) VALUES ('$username', '".md5($password)."', '$email', '$trn_date')";
        $result = mysqli_query($con,$query);
}
        if($result){
            echo "<div class='form'><h3>You are registered successfully.</h3><br/>Click here to <a href='entlogin.php'>Login</a></div>";
        }
    }else{
?>
    <!-- Navbar-->
   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i> ENTREPRENEUR REGISTER</h1>
...
<h1>Registration</h1>
  <div class="form">
<form name="entregistration" action="" method="post">
